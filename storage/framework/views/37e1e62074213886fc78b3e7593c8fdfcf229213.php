...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-6">
      <form action="/products/<?php echo e($product->id); ?>" method="POST" enctype="multipart/form-data">
        ...
        <?php echo csrf_field(); ?>
        <div class="mb-3">
          <label for="judulproduk" class="form-label">Judul Produk</label>
...
<?php echo $__env->make('pages.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\piah lsp-web-pbo\project-properti\resources\views/pages/produk/edit.blade.php ENDPATH**/ ?>